...
{block 'content'}
    ...
    Le recordamos que a la fecha no hemos recibido su oferta técnica requerida en el <b>Nº Concurso</b>: {$concurso->id},
    ...
    <ul>
        ...
        <li><b>Fecha límite para presentación de ofertas técnicas</b>:
            {$concurso->ficha_tecnica_fecha_limite->format('d-m-Y H:i:s')}<br><br></li>
    </ul>
