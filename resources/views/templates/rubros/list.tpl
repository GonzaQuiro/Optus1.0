    ...
    <div class="col-md-12">
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="btn-group">
                    <a 
                        href="/configuraciones/rubros/nuevo"
            ...
            <div class="portlet-body">
                ...
                <table class="table table-striped table-bordered" id="listaRubros">
                    <thead>
                        <tr>
                            <th>Nombre</th>
                    ...
                    <tbody data-bind="dataTablesForEach : { data: ListaRubros, options: { paging: true }}">
                        <tr>
                            <td class="col-md-6" data-bind="text: Nombre"></td>
                            <td class="col-md-2 text-center" data-bind="text: NumSubrubros"></td>
                            <td class="col-md-4 text-center">
                                <a data-bind="attr: {literal}{href: '/configuraciones/rubros/edicion/' + Id}{/literal}" class="btn btn-xs green" title="Editar">
                                    Editar 
                                    <i class="fa fa-pencil"></i>
                                </a>
                                <a data-bind="attr: {literal}{href: '/configuraciones/rubros/' + Id + '/subrubros'}{/literal}" class="btn btn-xs green" title="Sub Rubro">
                                    Sub Rubro 
...
var ConfiguracionesRubrosListado = function (data) {
    var self = this;

    this.Breadcrumbs = ko.observableArray(data.breadcrumbs);
    this.ListaRubros = ko.observableArray(data.list);
    
    this.Eliminar = function (id) {
        swal({
            title: '¿Está seguro de que desea eliminar el rubro?',
            type: 'info',
            ...
            if (result) {
                ...
                var url = '/configuraciones/rubros/delete/' + id;
...
jQuery(document).ready(function () {
    ...
    var url = '/configuraciones/rubros/list';
    Services.Get(url, data, 
        (response) => {
            if (response.success) {
                window.E = new ConfiguracionesRubrosListado(response.data);
                AppOptus.Bind(E);
            }
            $.unblockUI();
        }, 
