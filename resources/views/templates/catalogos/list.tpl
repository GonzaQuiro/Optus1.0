    ...
    <div class="col-md-12">
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="btn-group">
                    <a 
                        href="/configuraciones/catalogos/nuevo"
                        class="btn sbold green">
                        Agregar Nueva Categoría de Material
                    ...
                    <tbody data-bind="dataTablesForEach : { data: listaCatalogos, options: { paging: true }}">
                        <tr>
                            ...
                            <td class="col-md-4 text-center">
                                <a data-bind="attr: {literal}{href: '/configuraciones/catalogos/edicion/' + Id()}{/literal}" class="btn btn-xs green" title="Editar">
                                    Editar 
...
var ConfiguracionesCatalogosListado = function (data) {
    var self = this;
    ...
    if (data.list.length > 0) {
        data.list.forEach(item => {
            self.listaCatalogos.push(new Catalogo(item));
        });
    }
    ...
    this.Eliminar = function (id) {
        swal({
            ...
            if (result) {
                ...
                var url = '/configuraciones/catalogos/toggle/' + id;
...
jQuery(document).ready(function () {
    ...
    var url = '/configuraciones/catalogos/list';
    Services.Get(url, data, 
        (response) => {
            if (response.success) {
                window.E = new ConfiguracionesCatalogosListado(response.data);
                AppOptus.Bind(E);
            }
            $.unblockUI();
        }, 
